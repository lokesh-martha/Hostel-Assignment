import { RouteModuleOptions } from "next/dist/server/route-modules/route-module";
          ...
          {appliedRooms.length > 0 && (
            <div className={styles.section}>
              ...
              <div className={styles.pagination}>
                ...
                <span>
                  Page {inactivePage} of {Math.ceil(appliedRooms.length / itemsPerPage)}
                </span>
                <button
                  className={styles.button}
                  onClick={() =>
                    setInactivePage((p) =>
                      Math.min(p + 1, Math.ceil(appliedRooms.length / itemsPerPage))
                    )
                  }
                  disabled={inactivePage === Math.ceil(appliedRooms.length / itemsPerPage)}
                >
                  Next
                </button>
              </div>
